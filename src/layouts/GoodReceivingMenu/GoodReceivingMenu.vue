...
import { useGoodReceivingMenuStore } from "../../stores/good-receiving-menu";
import {
...
const sideMenuStore = useGoodReceivingMenuStore();
...
<template>
  <div class="py-5 md:py-0">
    ...
    <MainColorSwitcher />
    <MobileMenu />
    <TopBar layout="good-receiving-menu" />
